...
page 50105 "API - Items"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                {
                    Caption = 'Purchase Unit Of Measure Code';

                    trigger OnValidate()
                    begin
                        if not ValidateUnitOfMeasure.Get(Rec."Purch. Unit of Measure") then
                            Error(PurchUnitOfMeasureIdDoesNotMatchAUnitOfMeasureErr);
                        if (Rec."Purch. Unit of Measure" <> '') and (ValidateUnitOfMeasure.Code <> '') then
                            if ValidateUnitOfMeasure.Code <> Rec."Purch. Unit of Measure" then
                                Error(UnitOfMeasureValuesDontMatchErr);
                ...
                field(salesUnitOfMeasure; Rec."Sales Unit of Measure")
                {
                    ...
                    trigger OnValidate()
                    begin
                        if not ValidateUnitOfMeasure.Get(Rec."Sales Unit of Measure") then
                            Error(SaleUnitOfMeasureIdDoesNotMatchAUnitOfMeasureErr);
                        if (Rec."Sales Unit of Measure" <> '') and (ValidateUnitOfMeasure.Code <> '') then
                            if ValidateUnitOfMeasure.Code <> Rec."Sales Unit of Measure" then
                                Error(UnitOfMeasureValuesDontMatchErr);
                ...
                field(vendorItem; Rec."Vendor Item No.")
                {
                    Caption = 'Vendor Item';
                ...
                field(prerferredStockLevel; Rec."Safety Stock Quantity")
                {
                    Caption = 'Safety Stock Quantity';

                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("Safety Stock Quantity"));
                    end;
                }
                field(leadTime; Rec."Safety Lead Time")
                {
                    Caption = 'Safety Lead Time';

                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("Safety Lead Time"));
                    end;
                }
                field(countryOfManufacture; Rec."Country/Region of Origin Code")
                {
                    Caption = 'Country of Origin';

                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("Country/Region of Origin Code"));
                    end;
                }
                field(netWeight; Rec."Net Weight")
                {
                    ...
                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("Net Weight"));
                    end;
                }
                ...
                part(itemAttributes; "API - Item Attributes")
                {
                    ...
                    SubPageLink = "Inherited-From Table ID" = const(27), "Inherited-From Key Value" = field("No.");
                }
                ...
                part(itemVendors; "API - Item Vendor")
                {
                ...
                part(itemReferences; "API - Item References")
                {
    ...
    var
        ...
        PurchUnitOfMeasureIdDoesNotMatchAUnitOfMeasureErr: Label 'The "purchUnitOfMeasureId" does not match to a Unit of Measure.', Comment = 'PurchUnitOfMeasureId is a field name and should not be translated.';
        SaleUnitOfMeasureIdDoesNotMatchAUnitOfMeasureErr: Label 'The "saleUnitOfMeasureId" does not match to a Unit of Measure.', Comment = 'SaleUnitOfMeasureId is a field name and should not be translated.';
