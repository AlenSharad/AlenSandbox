...
page 50153 "API - Customer Payments"
{
    APIVersion = 'v2.0';
    ...
    begin
        ...
        BssiEntityID := Rec."Shortcut Dimension 1 Code";

        ProcessAppliesToInvoiceNumberAndId();
        Rec.BssiEntityID := BssiEntityID;
        Rec.BssiOriginalEntityID := BssiEntityID;
