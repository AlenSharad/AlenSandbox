pageextension 50123 "Sales Return Order Page Ext" extends "Sales Return Order"
{
    layout
    {
        ...
        addlast(General)
        {
            ...
            //     ToolTip = 'ALN - Specifies the total check for the order associated with the sales return.';
            // }
            // field("Order Total Variance"; Rec."Order Total Variance")
            // {
            //     ApplicationArea = All;
            //     Caption = 'Order Total Variance';
            //     ToolTip = 'ALN - Specifies the variance in the order total for the sales return.';
            // }
        ...
        addafter("Invoice Details")
        {
            group("Marketplace Details")
            {
                ...
                field("memo"; Rec."memo")
                {
                    ...
                    Caption = 'Memo';
                    Importance = Standard;
                    ToolTip = 'ALN - Specifies any additional notes or comments related to the sales return.';
                }
                ...
                field("shippingAddress_attention"; Rec."shippingAddress_attention")
                {
                    ...
                    Importance = Standard;
                    ToolTip = 'ALN - Specifies the attention line for the shipping address associated with the sales return.';
                }
                ...
                field("Carrier_Transportation_Method_Code"; Rec."Transportation_Method_Code")
                {
                    ...
                    Importance = Standard;
                    ToolTip = 'ALN - Specifies the transportation method code for the carrier associated with the sales return.';
                }
